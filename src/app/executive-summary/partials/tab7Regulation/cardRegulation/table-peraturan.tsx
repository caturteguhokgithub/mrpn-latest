...
export default function TablePeraturan({
  ...
  data?: doRequestRegulasiDto[];
  dataExsum?: ExsumRegulationResDto[];
  deleteData: any;
  penetapan?: boolean;
  setModal?: () => void;
  setModalDelete?: () => void;
  ...
  const handleBtnEdit = async (params: doRequestRegulasiDto, act: string) => {
    if (intExt) {
      setState?.((prevState) => ({
        ...prevState,
        id: params.id,
        no_regulasi: params.no_regulasi,
