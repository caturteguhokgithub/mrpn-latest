...
import { BuktiDukungReqDto, BuktiDukungResDto, initUploadBuktiDukung } from "./notaDinasModel";
...
const useNotaDinasVM = () => {
    ...
    const [gambarState, setGambarState] = useState<BuktiDukungReqDto>(initUploadImage);
