...
import {
  GetBuktiDukungServiceModel,
  UploadBuktiDukungServiceModel,
} from "./notaDinasModel";
...
export async function doUnggahBuktiDukung(
  param: UploadBuktiDukungServiceModel
) {
...
export async function doDeleteNodin(param: any) {
  const resp = await post({
    ...param,
    url: "penetapan/object/buktiDukung/delete",
  });
  if (resp) return Object.assign(new ResponseBaseDto(), resp);
}
